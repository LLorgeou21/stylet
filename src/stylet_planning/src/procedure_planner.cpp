...
// product degenerates).
Eigen::Quaterniond quaternionFromZAxis(const Eigen::Vector3d & z_axis_in)
{
...
private:
  ...
  // existing entries (unlike a partial diff, which replaces the whole
  // matrix - see allowNeedleTargetCollision()).
  static void setAllowedCollisionPair(
